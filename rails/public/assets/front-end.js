  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        block(env, morph6, context, "each", [get(env, context, "flashes.queue")], {"keyword": "flash"}, child6, null);
...
define('front-end/tests/unit/models/post-test', ['ember', 'ember-qunit'], function (Ember, ember_qunit) {
  ...
  ember_qunit.test("Format date", function () {
    // this.subject aliases the createRecord method on the model
    // debugger;
    var post = this.subject({ publishedDate: new Date(2014, 3, 3) });
